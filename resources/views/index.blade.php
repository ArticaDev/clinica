...
<nav class="navbar navbar-light fixed-top">
        <div class="container"><a class="navbar-brand logo js-scroll-trigger" href="#home"><img src="assets/img/0cd22a36-c30f-4004-9cea-0752a4fc9cc5-removebg-preview.png" style="height: 50px;width: 100px;"></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div
                class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav ml-auto">
                <li class="nav-item js-scroll-trigger" role="presentation"><a class="nav-link js-scroll-trigger" href="#home">Home</a></li>
    ...
    <main id="home" class="page landing-page">
        ...
        <section id="aboutus" class="clean-block features" style="background-color: rgb(244,244,244);">
            <div class="container">
                <div class="block-heading">
                    <h1 style="color: #efc585;font-family: 'Dancing Script',cursive;">Sobre <strong>Nós</strong></h1>
        ...
        <section id="local" class="clean-block about-us">
            <div class="container">
                <div class="block-heading">
                    <h1 style="color: #efc585;font-family: 'Montserrat';">Localização</h1>
                </div>
