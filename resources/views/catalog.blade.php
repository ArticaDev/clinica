            ...
            <div class="container">
                ...
                <div class="content" style="padding-top:50px;">
                    <div class="row align-items-center">
                        <div class="col-md-6 col-lg-4 col-xl-3 d-flex flex-column justify-content-center align-items-center" style="margin: 10px auto;">
                            <a href="product">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 d-flex flex-column justify-content-center align-items-center" style="margin: 10px auto;">
                            ...
                            <a href="product"><h3 class="text-center" style="margin-top: 25px;margin-bottom:50px;">Título do Procedimento 1</h3></a>
                                ...
                                <nav>
                                    <ul class="pagination" style="padding-bottom:50px;">
